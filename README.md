...
### A ideia central foi treinar habilidades de front-end através da construção de uma página completa, aplicando conceitos como:
    ...
    Mobile First: A versão mobile foi cuidadosamente planejada, com um menu hambúrguer moderno e animado.

    Estilização Profissional: Uso de tipografia, cores e espaçamentos que seguem um padrão visual limpo e organizado.
...
# 🛠️ Tecnologias Utilizadas
    ...
    CSS3 - Estilização completa, com media queries e animações

    JavaScript - Funcionalidade do menu hambúrguer e interações básicas
...
├── style.css           # Estilos CSS (incluindo versão mobile)
├── script.js           # JavaScript para o menu hambúrguer
│
├── assets/             # Pasta com recursos
│   ├── icones/         # Ícones utilizados no projeto
│   └── complementos/   # Imagens de fundo e fotos
│
...
Menu Hambúrguer Moderno
    ...
    Itens do menu com animação sequencial

    Overlay escuro com efeito blur no fundo
...
# Layout Responsivo
    ...
    Seções reorganizadas em coluna única

    Cards do time com scroll horizontal

    Filtros de projetos com rolagem horizontal
...
Cinza claro	#f3f0f0	Fundo das seções light
Branco	#FFFFFF	Textos e elementos de contraste
📏 Breakpoints

    Desktop: acima de 1024px (layout original)

    Tablet: entre 769px e 1023px (adaptações intermediárias)
...
# 🚀 Como Executar
    ...
    git clone https://github.com/seu-usuario/awax-project.git
...
# 📚 O que foi praticado
    ...
    ✔️ Flexbox para layouts complexos

    ✔️ Media queries para responsividade

    ✔️ Animações CSS com transitions

    ✔️ Manipulação do DOM com JavaScript

    ✔️ Event listeners e toggle de classes
...
# 💡 Próximos Passos (para continuar treinando)
    ...
    Implementar um slider funcional para os banners

    Criar filtros dinâmicos para os projetos
